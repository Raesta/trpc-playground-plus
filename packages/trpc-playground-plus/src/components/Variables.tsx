...
const Variables = ({ open, setOpen, variables, setVariables }: VariablesProps) => {
        ...
        <>
          ...
          <div
            style={{
              ...
              overflow: 'auto',
              zIndex: 10,
              animation: closing ? 'slideOutLeft 0.25s forwards' : 'slideInLeft 0.3s forwards',
            }}
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              <h3 style={{ color: t.colors.text.primary, margin: 0 }}>Variables</h3>
              <button
                onClick={handleClose}
                style={{
                  background: 'none',
